...
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		final String TESTFILE = "resources/inputFile03.txt";
		...
		System.out.println("---------------------------------------------");
		System.out.println("Output of example 3 with input test file \"inputFile03.txt\" where"
				+ "some queues are empty when calling dequeue() method of class:");
		System.out.println("---------------------------------------------");
